...
def run_page2():
    ...
    **Context & Business Value:**
    ...
    if 'simulation_base_df' in st.session_state:
        ...
        st.session_state.initial_simulation_results_df = initial_simulation_results_df
        ...
        **Interpretation:**
        ...
        st.warning("Please navigate to Page 1 to generate clinical data and train the AI model first.")